...
<body class="font-sans antialiased w-full h-screen bg-slate-100">
    <!-- Sidebar and Content -->
    <div class="flex flex-row h-full justify-start items-start">
        <!-- Sidebar -->
        <div class="h-full m-0 flex flex-col w-fit lg:w-16 bg-white" id="sidebar" x-transition
            x-data="{
                open: false,
                opendSubMenu: false,
                subMenuOpen: {
            ...
            <div popover id="sidebar-expanded"
                class="m-0 p-4 h-full w-fit flex flex-col overflow-y-auto items-center justify-between border-r border-gray-200 isolate z-10">
                <!-- Main Sidebar Content -->
                <div class="flex flex-col w-full" x-cloak>
                    <!-- Logo & Name -->
                    <div class="w-full hidden md:flex flex-row space-x-4 items-center">
                        <div class="w-10 h-10">
                    ...
                    <!-- Hamburger Menu -->
                    <div class="w-full md:pt-8 pl-2" x-on:click="openMenu()">
                    ...
                    <div
                        :class="{
                            'w-full flex flex-col space-y-6 pt-8': open,
                            'hidden w-full md:flex flex-col space-y-6 pt-8': !open
                        }">
                        <!-- Home -->
