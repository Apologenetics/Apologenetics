<x-app-layout>
    <div class="flex flex-col md:flex-row gap-4 w-full h-full pt-8 px-6" x-data="{
        showDoctrineModal: @entangle('showDoctrineModal')
    }">
        <!-- Column 1 -->
        <div class="flex flex-col gap-4 md:w-3/4 h-full">
                    ...
                    <p class="text-center md:text-left text-sm text-slate-400">
                        ...
                        @else
                            <span>
                                ...
                                venenatis cras sed. Ut porttitor leo a diam sollicitudin tempor id eu. Ultrices neque
                                ornare aenean euismod elementum. Dapibus ultrices in iaculis nunc
            ...
            <div class="w-full h-fit rounded-2xl shadow-xl bg-white flex flex-col space-y-2 p-8">
                <div class="w-full flex flex-row justify-between">
                    ...
                    <button
                        onclick="Livewire.dispatch('openModal', {component: 'nuggets.create', arguments: {{ json_encode([
        ...
        <!-- Column 2 -->
        <div class="flex flex-col gap-4 md:w-1/4 h-full">
            <div class="w-full h-fit rounded-2xl shadow-xl bg-white flex flex-row p-8 justify-between">
                <!-- Column 1 -->
                <div class="flex flex-col justify-between space-y-8">
                    <!-- Row 1 -->
                    <div class="flex flex-col space-y-2 items-center">
                        <svg class="text-sky-900" width="40" height="40" viewBox="0 0 24 24" fill="none"
        ...
        @push('modal')
            <x-modal id="doctrine-modal" wire:model="showDoctrineModal">
                <livewire doctrines.create :entity="$religion" :denominations="$denominations" :religion="$religions" />
            </x-modal>
        @endpush
    </div>
</x-app-layout>
