        ...
        @if ($hasControls)
            <div class="flex flex-row space-x-8 items-center">
                ...
                @if (auth()->id() === $item->created_by)
                    <!-- Edit -->
                    <button class="flex flex-row space-x-2 text-sky-500 hover:text-sky-600 hover:cursor-pointer" wire:click="edit">
                        <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M19.8496 9.82978C19.7796 9.82978 19.7096 9.81978 19.6496 9.79978C17.0196 9.05978 14.9296 6.96978 14.1896 4.33978C14.0796 3.93978 14.3096 3.52978 14.7096 3.40978C15.1096 3.29978 15.5196 3.52978 15.6296 3.92978C16.2296 6.05978 17.9196 7.74978 20.0496 8.34978C20.4496 8.45978 20.6796 8.87978 20.5696 9.27978C20.4796 9.61978 20.1796 9.82978 19.8496 9.82978Z" fill="currentColor"/>
                        </svg>
                    </button>
                    <!-- Delete -->
                    <button class="flex flex-row space-x-2 text-red-500 hover:text-red-600 hover:cursor-pointer" wire:click="delete">
                        <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
