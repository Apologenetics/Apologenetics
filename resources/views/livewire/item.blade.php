        ...
        @if ($hasControls)
            <div class="flex flex-row space-x-8 items-center">
                ...
                @if (auth()->id() === $item->created_by)
                    <!-- Edit -->
                    <button class="flex flex-row space-x-2 text-sky-300 hover:text-sky-600 hover:cursor-pointer" wire:click="edit">
                    ...
                    <!-- Delete -->
                    <button class="flex flex-row space-x-2 text-red-300 hover:text-red-600 hover:cursor-pointer" wire:click="delete">
                        <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
