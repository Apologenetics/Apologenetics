<div class="flex flex-col space-y-4 bg-white shadow-lg rounded-2xl w-full h-auto p-8">
    <div class="flex flex-row space-x-4 w-full">
        ...
        <div class="flex flex-col space-y-2 w-full">
            ...
            <x-input wire:model.defer="state.first_name" class="w-full" type="text" id="first_name" value="{{ $user->first_name }}" />
            <x-label for="gender" class="font-medium text-sm text-gray-700">{{ __('Gender') }}</x-label>
        ...
        <div class="flex flex-col space-y-2 w-full">
            ...
            <x-input wire:model.defer="state.last_name" class="w-full" type="text" value="{{ $user->last_name }}" />
        </div>
    </div>
