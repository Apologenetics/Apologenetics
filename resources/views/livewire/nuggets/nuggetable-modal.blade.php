...
<div class="flex flex-col p-8 space-y-8">
    ...
    @else
        <div class="flex flex-col space-y-8 divide-y-2 divide-sky-300">
    ...
    <div class="relative items-center">
        <input type="search" id="search" class="block py-4 px-6 w-full text-sm text-gray-900 bg-white rounded-lg shadow-xl border-sky-200" placeholder="Add comment...">
