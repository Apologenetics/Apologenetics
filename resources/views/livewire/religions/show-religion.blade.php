<div class="flex flex-col md:flex-row gap-4 w-full h-fit pt-8 px-8 overflow-y-auto" x-data="{
            ...
            <div
                ...
                <div class="w-full flex flex-row justify-between">
                    ...
                    <button @click="showDoctrineModal = !showDoctrineModal">
                        <svg class="text-gray-400 hover:text-gray-700 dark:hover:text-gray-500 transition"
    ...
    @push('modal')
        <x-modal id="doctrine-modal" wire:model="showDoctrineModal">
            <livewire:doctrines.create :religionId="$religion->getKey()" />
        </x-modal>
